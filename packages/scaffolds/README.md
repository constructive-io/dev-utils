...
- Interactive prompts powered by `commodore`, with flexible override mapping (`argv` support) and non-TTY mode for CI
...
- `scaffold(options)`: Scaffold a project from a template:
  ...
  - `prompter`: Reuse an existing Commodore instance
