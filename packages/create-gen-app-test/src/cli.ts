...
import { Commodore, ListQuestion } from 'commodore';
import minimist, { ParsedArgs } from 'minimist';

import { CacheManager, GitCloner, checkNpmVersion } from '@commodore/scaffolds';
...
const PACKAGE_NAME = '@commodore/scaffolds';
