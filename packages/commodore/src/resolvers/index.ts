...
export class DefaultResolverRegistry {
    ...
    async resolve(key: string): Promise<any> {
        ...
        try {
            ...
            if (process.env.DEBUG === 'commodore') {
                console.error(`[commodore] Resolver '${key}' failed:`, error);
            }
            return undefined;
        }
    }
 ...
 * This is the default registry used by Commodore unless a custom one is provided.
 */
