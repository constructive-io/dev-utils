...
import { Commodore } from './prompt';
import { getVersion } from './utils';

// Define the type for the command handler function
export type CommandHandler = (argv: ParsedArgs, prompter: Commodore, options: CLIOptions) => void;
