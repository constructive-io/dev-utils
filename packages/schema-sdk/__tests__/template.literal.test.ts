...
it('/osmosis/{gamm}/v1beta1/estimate/swap_exact_amount_in', () => {
  expect(
    renderTemplateTag('/osmosis/{gamm}/v1beta1/estimate/swap_exact_amount_in')
...
it('/osmosis/{gamm}/v1beta1/{estimate}/swap_exact_amount_in', () => {
  expect(
    ...
    '`/osmosis/${params.gamm}/v1beta1/${params.estimate}/swap_exact_amount_in`'
  );
});
...
it('/osmosis/{gamm}/{v1beta1}/{estimate}/{swap_exact_amount_in}', () => {
  expect(
    renderTemplateTag(
      '/osmosis/{gamm}/{v1beta1}/{estimate}/{swap_exact_amount_in}'
    )
  ).toEqual(
    '`/osmosis/${params.gamm}/${params.v1beta1}/${params.estimate}/${params.swap_exact_amount_in}`'
  );
});
...
it('/cosmos/feegrant/v1beta1/allowance/{granter}/{grantee}', () => {
  expect(
    renderTemplateTag('/cosmos/feegrant/v1beta1/allowance/{granter}/{grantee}')
  ).toEqual(
    '`/cosmos/feegrant/v1beta1/allowance/${params.granter}/${params.grantee}`'
  );
});
...
it('/cosmos/group/v1/vote_by_proposal_voter/{proposal_id}/{voter}', () => {
  expect(
    ...
    '`/cosmos/group/v1/vote_by_proposal_voter/${params.proposal_id}/${params.voter}`'
  );
});

it('/cosmos/gov/v1beta1/proposals/{proposal_id}/tally', () => {
  expect(
    renderTemplateTag('/cosmos/gov/v1beta1/proposals/{proposal_id}/tally')
...
it('/cosmos/staking/v1beta1/validators/{validator_addr}/delegations', () => {
  expect(
    ...
    '`/cosmos/staking/v1beta1/validators/${params.validator_addr}/delegations`'
  );
});
...
it('/cosmos/staking/v1beta1/validators/{validator_addr}/delegations/{delegator_addr}', () => {
  expect(
    ...
    '`/cosmos/staking/v1beta1/validators/${params.validator_addr}/delegations/${params.delegator_addr}`'
  );
});
...
it('/cosmos/gov/v1beta1/proposals/{proposal_id}/votes/{voter}', () => {
  expect(
    ...
    '`/cosmos/gov/v1beta1/proposals/${params.proposal_id}/votes/${params.voter}`'
  );
});
